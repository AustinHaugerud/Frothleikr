...
ftr_u16 ftr_assemble_u16l(const struct ftr_brokeu16 * val) {
...
ftr_u32 ftr_assemble_u32l(const struct ftr_brokeu32 * val) {

    ftr_u32 aval;
    const ftr_u8 * bytes = &val->bytes[0];
...
ftr_u64 ftr_assemble_u64l(const struct ftr_brokeu64 * val) {
...
ftr_u16 ftr_assemble_u16b(const struct ftr_brokeu16 * val) {
    ftr_u16 aval;
...
ftr_u32 ftr_assemble_u32b(const struct ftr_brokeu32 * val) {
    ftr_u32 aval;
    const ftr_u8 * bytes = &val->bytes[0];
...
ftr_u64 ftr_assemble_u64b(const struct ftr_brokeu64 * val) {
    ftr_u64 aval;
    const ftr_u8 * bytes = &val->bytes[0];
...
ftr_s16 ftr_assemble_s16l(const struct ftr_brokes16 * val) {
    ftr_u16 aval;
...
ftr_s32 ftr_assemble_s32l(const struct ftr_brokes32 * val) {
    ftr_u32 aval;
...
ftr_s64 ftr_assemble_s64l(const struct ftr_brokes64 * val) {
    ftr_u64 aval;
    const ftr_u8 * bytes = &val->bytes[0];
...
ftr_s16 ftr_assemble_s16b(const struct ftr_brokes16 * val) {
    ftr_s16 aval;
...
ftr_s32 ftr_assemble_s32b(const struct ftr_brokes32 * val) {
    ftr_s32 aval;
    const ftr_u8 * bytes = &val->bytes[0];
...
ftr_s64 ftr_assemble_s64b(const struct ftr_brokes64 * val) {
    ftr_s64 aval;
    const ftr_u8 * bytes = &val->bytes[0];
