...
ftr_u16 FTR_API ftr_assemble_u16l(struct ftr_brokeu16 * val);

ftr_u32 FTR_API ftr_assemble_u32l(struct ftr_brokeu32 * val);

ftr_u64 FTR_API ftr_assemble_u64l(struct ftr_brokeu64 * val);
...
ftr_u16 FTR_API ftr_assemble_u16b(struct ftr_brokeu16 * val);

ftr_u32 FTR_API ftr_assemble_u32b(struct ftr_brokeu32 * val);

ftr_u64 FTR_API ftr_assemble_u64b(struct ftr_brokeu64 * val);
/**********************************************/
...
ftr_s16 FTR_API ftr_assemble_s16l(struct ftr_brokes16 * val);

ftr_s32 FTR_API ftr_assemble_s32l(struct ftr_brokes32 * val);

ftr_s64 FTR_API ftr_assemble_s64l(struct ftr_brokes64 * val);
...
ftr_s16 FTR_API ftr_assemble_s16b(struct ftr_brokes16 * val);

ftr_s32 FTR_API ftr_assemble_s32b(struct ftr_brokes32 * val);

ftr_s64 FTR_API ftr_assemble_s64b(struct ftr_brokes64 * val);
